'''A group of statisticians at a localers. Define these functions
in a module named stats college has asked you to create a set of functions
that compute the median and mode of a set of numb.py. Also include a function named mean, which computes
